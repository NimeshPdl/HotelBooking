package com.nimesh.hotelbooking;
...
public class MainActivity extends AppCompatActivity {
    ...
    EditText etAdult,etChild,etRoom,Name;
    Button btnBook;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String countries[]={"Nepal","Srilanka","Bhutan","India","China"};
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if (suite == "AC\n Rs.3000")
                {
                    ...
                    tvVat.setText("Grand Total:"+Grand_Total);
                    Toast.makeText(MainActivity.this,
                            "Total price is" + Grand_Total, Toast.LENGTH_SHORT).show();
                }
